...
public class DefaultScoreListener implements IterationListener {
    ...
    public DefaultScoreListener(int printIterations, Function<Object,Double> testErrorFunction, Function<Object,Double> trainErrorFunction, Function2<LocalDateTime,Double,Void> saveFunction) {
